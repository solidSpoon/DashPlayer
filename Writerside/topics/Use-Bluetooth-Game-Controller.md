...
2. 进入 DashPlayer 快捷键设置, 设置手柄对应按键为快捷键
    1. 打开 <control>设置中心</control> → <control>快捷键</control>
    2. 找到对应功能, 点击<control>编辑快捷键</control>
    3. 在录制窗口中点击录制区域激活监听
    4. 按下手柄对应按键
    5. 点击<control>添加此按键</control>, 再点击<control>完成并保存</control>
    6. 重复 2-5 步骤, 直到设置完成
3. 开始使用吧!

> 一个快捷键可以绑定多个按键, 在编辑窗口中多次录制并添加即可.
