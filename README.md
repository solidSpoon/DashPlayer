...
- **查词查询**：鼠标悬停生词可快速查询，不打断学习进程；内置离线常用词词典（Collins 星级、词频、考试标签），未配置任何 API 密钥也能开箱即用。
...
- [ECDICT](https://github.com/skywind3000/ECDICT)（MIT License）：内置离线词典数据基于 ECDICT 常用词子集构建，包含音标、释义、Collins 星级、词频与考试标签。
