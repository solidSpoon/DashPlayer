...
## [6.13.0](https://github.com/solidSpoon/DashPlayer/compare/v6.12.3...v6.13.0) (2026-09-13)


### Features

* add chat session transport ([34e8067](https://github.com/solidSpoon/DashPlayer/commit/34e8067c2d4be891c658b8247e00b43f8a257272))
* add model download context menu ([8bb3123](https://github.com/solidSpoon/DashPlayer/commit/8bb31235d11eb4234165090811eb0e0d5ff5db8e))
* add sentence learning model selector ([89ee039](https://github.com/solidSpoon/DashPlayer/commit/89ee0394d9d04861769f8d313725627fa0b42a3d))
* add subtitle context tools to chat agent ([e5d36e8](https://github.com/solidSpoon/DashPlayer/commit/e5d36e848a1f55e3ad760bbbefcead72a7a38a9b))
* **favourite:** modernize saved moments with card items, refined player controls, and clean filter bar ([53560ea](https://github.com/solidSpoon/DashPlayer/commit/53560ea4bfb721bdc7cd4a2808e08148a9fd1c20))
* improve multi-step tool rendering and subtitle scroll restoration ([7b55519](https://github.com/solidSpoon/DashPlayer/commit/7b55519d4db610efc03415a4b067398692cbfc25))
* improve speech model downloads ([340d529](https://github.com/solidSpoon/DashPlayer/commit/340d5299c2d4f8210bd802fad30f35be8044b41c))
* install shadcn AI components ([9de298c](https://github.com/solidSpoon/DashPlayer/commit/9de298cf47cebd03d8941b4ffd35f485bbdfcf19))
* integrate AI subtitle viewer ([1372015](https://github.com/solidSpoon/DashPlayer/commit/137201552a14cf42fb3161067c48bfdbf195dd55))
...
* **observability:** 加固日志证据链，崩溃与后台任务可通过 grep 完整还原 ([1ed5291](https://github.com/solidSpoon/DashPlayer/commit/1ed5291226e0651e70e00a373618f4e255909f85))
* **player:** add 3-track subtitle pills with source chinese toggle ([7e82072](https://github.com/solidSpoon/DashPlayer/commit/7e8207238010e32a68342156267e1570f17240fb))
* **player:** modernize bottom control bar and refine slider interaction ([70ae2f2](https://github.com/solidSpoon/DashPlayer/commit/70ae2f226408a1ef42681043138d0266b7a1755e))
* **player:** refine control box, hero card progress, and modern dark tooltips ([1d673cf](https://github.com/solidSpoon/DashPlayer/commit/1d673cfb67d57d45daa66cedbdd0c2c52b7b3ef0))
* **player:** 优化训练模式交互与持久化配置并重构胶囊控制条 ([ebec2f3](https://github.com/solidSpoon/DashPlayer/commit/ebec2f38627f0affa10eb46e8083196fdefc74f2))
* **player:** 升级 react-virtuoso 至 4.18.12 并优化虚拟列表配置 ([98fb577](https://github.com/solidSpoon/DashPlayer/commit/98fb577a259d527d5ea87137b44e813d16a214a5))
* **player:** 实现主字幕区动态环境光贯通与毛玻璃质感 ([6043d15](https://github.com/solidSpoon/DashPlayer/commit/6043d150f828c03662f2ace410a74c579a4891f7))
* **player:** 播放卡死改为统一提示，支持跳转换页或暂时忽略当前视频 ([5cd14b3](https://github.com/solidSpoon/DashPlayer/commit/5cd14b305957189a2d80a23003428f4f91bc9cff))
* **player:** 新增训练模式：常开逐句循环、影子跟读、跳过句间空隙与暂停回退句首 ([caab56a](https://github.com/solidSpoon/DashPlayer/commit/caab56a82694a3d3594ab646906b0980dc1b960d))
* **player:** 格式兼容改为乐观播放，播放失败或疑似无声时才引导转换 ([f938368](https://github.com/solidSpoon/DashPlayer/commit/f9383684c79c9ae35f704cf666ee4d0a31419214))
* **player:** 训练模式句末过渡跟随"跳过句间空隙"开关 ([77deb7a](https://github.com/solidSpoon/DashPlayer/commit/77deb7a87fc0b65cf11b827c4ea8baaf56788254))
* **player:** 重构主字幕区布局与极简悬浮控制栏 ([b424c17](https://github.com/solidSpoon/DashPlayer/commit/b424c17fbc984edcfb51b813ab7df072d2cbac4a))
* **player:** 鼠标点击后自动让非输入类元素失焦，避免焦点残留导致快捷键冲突 ([1e06171](https://github.com/solidSpoon/DashPlayer/commit/1e0617106856277283fd4c0f1724a1bb69e6900b))
* **podcast:** 彻底重构播客模式视觉与沉浸式字幕流体验 ([bca941f](https://github.com/solidSpoon/DashPlayer/commit/bca941f9e47d2994798cbd37c8fdbbeda295a3ed))
* Qwen3.5 本地大模型下载接入国内镜像 ([81eccff](https://github.com/solidSpoon/DashPlayer/commit/81eccff7a65697c587625b98c3bb65bb57aae010))
* refine sentence learning chat controls ([38a84ab](https://github.com/solidSpoon/DashPlayer/commit/38a84ab3f1e8390a2d095003fd54d437cf570dca))
* replace compromise with wink lemma matching ([ebb0ba6](https://github.com/solidSpoon/DashPlayer/commit/ebb0ba61c398eba2ea5ca46ae6a5125375b4de42))
...
* **settings:** redesign about page with theme logo, quick action links, and i18n copy ([de2591c](https://github.com/solidSpoon/DashPlayer/commit/de2591c5faa8f0aaa11a35bc12cb0fd1b6569726))
* **settings:** redesign settings layout with floating sidebar and breadcrumb navigation ([ab3f44a](https://github.com/solidSpoon/DashPlayer/commit/ab3f44a2d1204dce2ff7f3b1cfba6528b5578d9d))
* **settings:** redesign shortcuts page with grouped cards, key search, and interactive record dialog ([44b3634](https://github.com/solidSpoon/DashPlayer/commit/44b363483fb5d8a411c54c2f14d37bbd98a46309))
* **settings:** refine offline model cards, manual guides, and smooth alert dialogs ([4552a94](https://github.com/solidSpoon/DashPlayer/commit/4552a942a88114144f1320e7f27a1228cb717df5))
* **settings:** standardize settings pages with card sections, rows, and loading skeletons ([5d0297f](https://github.com/solidSpoon/DashPlayer/commit/5d0297fe3eff6a834ddee8af5517301c171232f6))
...
* **settings:** 重构外观设置卡片、分段字号选择器与实时字幕预览视口 ([cc9e632](https://github.com/solidSpoon/DashPlayer/commit/cc9e63212d3e125bf315f6a10a5b6a236199de05))
* **settings:** 重构本地模型卡片交互与文案 ([efbcf5e](https://github.com/solidSpoon/DashPlayer/commit/efbcf5e4850ac826b181422fcc6efe7b48b31f5e))
* soften chat tool activity display ([04e663a](https://github.com/solidSpoon/DashPlayer/commit/04e663a6e47a660d20ad15d384fd061c49f3fa04))
...
* **transcript:** redesign subtitle workspace with card sections, badge statuses, and clean layout ([5b1803e](https://github.com/solidSpoon/DashPlayer/commit/5b1803eeaccee660b9c563819abe70d64dfaf87a))
* **transcript:** 增量字幕复用已构建句子跳过解析并处理会话结束回退 ([7ccc7d3](https://github.com/solidSpoon/DashPlayer/commit/7ccc7d32dbe6ff62df8bc7883a5d3c6d1fddf7d0))
* **transcript:** 支持增量字幕转录，按播放位置就近调度块优先级 ([cc48626](https://github.com/solidSpoon/DashPlayer/commit/cc48626cb840b312e1fea67b1db75c3f5b0aecfd))
* **transcript:** 统一增量转录为虚拟 SRT 管道，支持翻译调度 ([023025f](https://github.com/solidSpoon/DashPlayer/commit/023025f75971585b3099267de41e483d637f2c67))
* **transcript:** 转录剩余块按播放位置逐轮重排，跳转可改变优先级 ([0783dea](https://github.com/solidSpoon/DashPlayer/commit/0783deabe39b041d7bb5eabb0fc0fef3ea0fb95e))
...
* 后端持久化转录任务 ([bfc9758](https://github.com/solidSpoon/DashPlayer/commit/bfc975834c4a0ae307680ae0d63e191eee8ddf26))
* 国际化用户界面文案 ([6329c97](https://github.com/solidSpoon/DashPlayer/commit/6329c9706a3b6c27ecbc29514ae522273bfab986))
...
* 新增 OPUS-MT 轻量翻译引擎（en→zh） ([e467356](https://github.com/solidSpoon/DashPlayer/commit/e467356853ff7350a9f2d720c7adda5a0e351478))
...
* 新增视频学习词汇管理与编辑功能 ([6172cf6](https://github.com/solidSpoon/DashPlayer/commit/6172cf6ca76dd2695cecacb94bf1e4c6a29ab58a))
...
* 本地字幕批量翻译改为紧凑行式输出 ([83e5685](https://github.com/solidSpoon/DashPlayer/commit/83e56855a6626c234dc8d661cfc0fcf7950c4bb6))
...
* 本地模型推理放开为全平台 ([c942b5d](https://github.com/solidSpoon/DashPlayer/commit/c942b5d03be4c194b29e5b840b3741bccf1f32ce))
* 本地模型推理放开为全平台 ([4f13b52](https://github.com/solidSpoon/DashPlayer/commit/4f13b529e8f1231e1d87e9bb4d1b45234f7a7e88))
...
* 简化控制台日志格式 ([5cd3b15](https://github.com/solidSpoon/DashPlayer/commit/5cd3b153b6ca2e484fce93a7f73b568e3872cf07))
...
* 记录日志软件版本 ([2b9b5f8](https://github.com/solidSpoon/DashPlayer/commit/2b9b5f840163b554240bf25e70bb2e173aa09170))
...
* 重构字幕翻译窗口调度 ([27f8b2a](https://github.com/solidSpoon/DashPlayer/commit/27f8b2a92e080cc86579f06429d18a6b89feb8c2))
...
* **ai-elements:** 修复 ReasoningTrigger 思考摘要超出一行的排版问题 ([64de488](https://github.com/solidSpoon/DashPlayer/commit/64de488b57130efe63df69d8c4bd6509cccc9a23))
* **chat:** merge tool activity display by visible replies ([18020a5](https://github.com/solidSpoon/DashPlayer/commit/18020a5cce83988d11aa8d9304efc0f5874c97fb))
* **chat:** relax search_subtitles keyword constraints and refine streaming reasoning render ([bfa2c6c](https://github.com/solidSpoon/DashPlayer/commit/bfa2c6c376c07b1205ab9e2a72e9a741a6462f08))
...
* clean up renderer API response listeners ([9d10843](https://github.com/solidSpoon/DashPlayer/commit/9d1084342a3ed17886cc238c1fc2f19f8a956b5d))
* **favourite:** allow space key for global play-pause and wrap long subtitles naturally ([60466d1](https://github.com/solidSpoon/DashPlayer/commit/60466d1654aee28a353a27b5e4d3163bd5f3ee2c))
* **favourite:** prevent text jumping by stabilizing highlighted sentence layout and font weight ([af82935](https://github.com/solidSpoon/DashPlayer/commit/af829356e4f7ea7a5be2b1aebdc90d3803774eb7))
* **favourite:** restore natural inline text flow for subtitle context ([90d051c](https://github.com/solidSpoon/DashPlayer/commit/90d051c72b107480b9040a06e4acc126a4498b82))
...
* **file-browser:** 修复视频缩略图因 setTimeout 竞态导致透明不显示 ([9a673b8](https://github.com/solidSpoon/DashPlayer/commit/9a673b8e4049d6be78013bc3a37a95e1e109cbb3))
* handle closed development log pipes ([162b01b](https://github.com/solidSpoon/DashPlayer/commit/162b01bceb6f5c8872045eef39f38d3d74b8cffa))
* **i18n,ui:** 优化中英文文案、统一“收藏片段”术语并修复侧边栏选中高亮阴影 ([29e06d0](https://github.com/solidSpoon/DashPlayer/commit/29e06d0da92a1e8124669a50b62f75ca7ea8eecf))
* improve subtitle translation reliability ([f07e74d](https://github.com/solidSpoon/DashPlayer/commit/f07e74d033a4be5c1aab2f40dd586bf360105834))
* isolate subtitle demand IDs by renderer session ([dcb9a9e](https://github.com/solidSpoon/DashPlayer/commit/dcb9a9ed26e4d508743ee15af77ddab80023f5ed))
* Linux 打包命名统一为 dashplayer 以匹配窗口身份 ([06fed72](https://github.com/solidSpoon/DashPlayer/commit/06fed72ce2093cc692c1f2e03c069a2b43bbb709))
* Linux 打包命名统一为 dashplayer 以匹配窗口身份 ([bb23114](https://github.com/solidSpoon/DashPlayer/commit/bb23114fa9c27b2175475c8c6ad65e5942371637))
...
* **observability:** 取消判定只按异常类型名，ffmpeg 失败收敛为网关单点记录 ([9ecdb0a](https://github.com/solidSpoon/DashPlayer/commit/9ecdb0a58752204706fab739210a3b385bc6a5ca))
...
* **playable:** restore click-to-pronounce on text while supporting drag selection ([2ae4492](https://github.com/solidSpoon/DashPlayer/commit/2ae44920da6d8050dbf9b339d3fd4ef20c936fc2))
* **player:** refine fullscreen subtitle style and hidden english placeholder UX ([86fada4](https://github.com/solidSpoon/DashPlayer/commit/86fada449dd167938eb43d3736ca2156cdcccbd1))
* **player:** 优化字幕虚拟列表滚动与安全边界检测机制 ([20f1a71](https://github.com/solidSpoon/DashPlayer/commit/20f1a71fa5c435951ede1f0779dfbe8eea93a977))
* **player:** 优化播放异常与卡死提示文案，从用户视角统一引导 ([159f243](https://github.com/solidSpoon/DashPlayer/commit/159f243fede959e36e742fcb8b25e169d05aa580))
* **player:** 修复增量字幕生成下的列表滚动与定位异常并调优字体 ([b618e86](https://github.com/solidSpoon/DashPlayer/commit/b618e86cb1673858641931ae66522b5cc2468cba))
* **player:** 修复播客模式跳转、播放按钮正圆与字幕轨道多选 ([3c5e8da](https://github.com/solidSpoon/DashPlayer/commit/3c5e8da7bad080c4fc906981c52c7bcc11ea6018))
* **player:** 修复播客模式退出画面消失与小窗滚动对齐问题 ([a160be7](https://github.com/solidSpoon/DashPlayer/commit/a160be7dfeb2227e81b1009c55a03109bf7bd398))
* **player:** 修复播放异常弹窗中操作按钮的排版与对齐样式 ([acb8492](https://github.com/solidSpoon/DashPlayer/commit/acb8492d37d240e22685fbd9bfe82fa9e8533759))
* **player:** 视频播放推进至视口内时自动解除浏览模式并优化侧边排版 ([41fd850](https://github.com/solidSpoon/DashPlayer/commit/41fd850eaafc5feb27601dcc0c3a932e09ddbfd8))
* **player:** 转录按钮不再订阅高频播放时钟，消除每帧重渲染与日志刷屏 ([fc2408b](https://github.com/solidSpoon/DashPlayer/commit/fc2408b2732db27a463965fed4f14a55b67bcd40))
* **player:** 重构字幕滚动容器用户输入中断与同步逻辑 ([b12f583](https://github.com/solidSpoon/DashPlayer/commit/b12f583501990bbcff189cf4603b86d18ff81ff6))
...
* recreate subtitle sessions for new renderers ([7d6ca3d](https://github.com/solidSpoon/DashPlayer/commit/7d6ca3d45657b0394f774c50dd4bb25d7681183f))
* reject stale subtitle renderer sessions ([997dabb](https://github.com/solidSpoon/DashPlayer/commit/997dabbcb1ecce1c8339b4f3c3082cad435936fc))
* resolve react compiler lint violations ([5d0b0cf](https://github.com/solidSpoon/DashPlayer/commit/5d0b0cf3516e3bddbfd792c4b5ae77475c6c9f37))
* restore custom scrollbar styles ([df81cdf](https://github.com/solidSpoon/DashPlayer/commit/df81cdf39e7f2526c162b7220ac8d9829b326975))
* **settings:** 修正关于页面标题居中问题 ([e6ce30f](https://github.com/solidSpoon/DashPlayer/commit/e6ce30f06d54d3e713514192a5b972fad8c4708c))
* simplify sentence phrase layout ([e045fd4](https://github.com/solidSpoon/DashPlayer/commit/e045fd401970ac4a78d0985a186526bd061de196))
* smooth sentence learning stream rendering ([a995833](https://github.com/solidSpoon/DashPlayer/commit/a9958331c111b144eea704f3e2d0b669f62f076a))
...
* **training:** 训练开关收敛到 trainingStore 持久化，模式命令统一走 PlayerActions ([bcb699f](https://github.com/solidSpoon/DashPlayer/commit/bcb699f6035f0b3a17dd8a443d1320c3fd0c8dca))
* **transcript:** 播放位置需求上报按识别块边界去重，消除稳态盲轮询 ([9a3ae7f](https://github.com/solidSpoon/DashPlayer/commit/9a3ae7f7e5671d07c9cc83b336f1c71106e3dda6))
* **translatable-line:** allow natural word wrapping by replacing whitespace-pre with whitespace-pre-wrap ([0b9b854](https://github.com/solidSpoon/DashPlayer/commit/0b9b8549490369754609cd1d22024d6a6f734775))
* **translation:** 调度器按句子稳定坐标分批，修复增量字幕翻译窗口错位 ([80289c8](https://github.com/solidSpoon/DashPlayer/commit/80289c8196c2311f9bab8437a4ab5dc8b676716e))
...
* **vocabulary-studio:** import missing cn utility function ([2509c18](https://github.com/solidSpoon/DashPlayer/commit/2509c1816eb6c44ee25b035fce9595da85350323))
* wait for database migration before service initialization ([ca4d29f](https://github.com/solidSpoon/DashPlayer/commit/ca4d29fd902637ce0775f0f3922124f89198470b))
...
* 修复播放器切页后的字幕翻译 ([193434d](https://github.com/solidSpoon/DashPlayer/commit/193434d5cd6de58c32708e4b568737a640a3b05c))
* 修复轻量翻译模型删除弹窗确认/取消按钮国际化键缺失问题 ([b4541a1](https://github.com/solidSpoon/DashPlayer/commit/b4541a190eae78c79248daf6043aefcbac5cacc9))
...
* 本地字幕翻译按 GBNF 约束解码行数，修复批次行数不匹配死信 ([4ca1003](https://github.com/solidSpoon/DashPlayer/commit/4ca10039a82504b3aaaa0a1ab7dda7090c863f45))
...
* 紧凑行式输出剥离列表/序号前缀 ([d2a8360](https://github.com/solidSpoon/DashPlayer/commit/d2a8360894fd42153fd3fbff4971ddf9448c82e5))
...
* 补充 EngineSelectionSetting 中缺失的 Loader2 图标导入 ([fb0e23b](https://github.com/solidSpoon/DashPlayer/commit/fb0e23b3337aec6ee87fb8eb3eb505b0a70f18b3))
...
* 调整字幕翻译窗口调度 ([f6724d1](https://github.com/solidSpoon/DashPlayer/commit/f6724d16026f710b733391c0073e462e61480b2b))
* 轻量翻译引擎原生依赖打包修复（macOS 动态 require 崩溃） ([cba69c6](https://github.com/solidSpoon/DashPlayer/commit/cba69c68ebfdb78bea1ad89427a3af460ee60679))
* 轻量翻译引擎原生库改为按需加载，不再拖垮启动 ([d421dc1](https://github.com/solidSpoon/DashPlayer/commit/d421dc1cc6c29b9b5ed88ff26cce9c4c6eb7c919))
* 轻量翻译模型下载进度桥接到设置页 ([c347d21](https://github.com/solidSpoon/DashPlayer/commit/c347d217122c2dd4dd68e690e08e9d00a41a8235))
...
* 避免首次字幕翻译会话被释放 ([bcbc86f](https://github.com/solidSpoon/DashPlayer/commit/bcbc86f243f77206880e16411ad66f29c0f3262d))
...
* 隐藏已下载模型的下载按钮 ([665b9ce](https://github.com/solidSpoon/DashPlayer/commit/665b9ced31d4ac427b2aff776277212d81df7e41))
* 隔离开发与生产存储路径 ([d05529e](https://github.com/solidSpoon/DashPlayer/commit/d05529ed702e0a25b095c6a879fda0b31a1feddb))


### Performance Improvements

* add startup timing instrumentation ([15dbff6](https://github.com/solidSpoon/DashPlayer/commit/15dbff68ecf4c85c5887b5259ef43d486d7054ed))
* decouple playback startup and subtitle analysis ([5b650ca](https://github.com/solidSpoon/DashPlayer/commit/5b650cafb358f88cc8802d9682aea423fb310175))
* **player:** 字幕翻译需求 150ms 防抖，合并键盘快跳产生的连续请求 ([9028c2b](https://github.com/solidSpoon/DashPlayer/commit/9028c2ba8f77ba9bcc28bad5cd67b8cb8f1ad549))
...
* 精简本地字幕翻译提示词，禁照抄规则正向措辞并贴近源文 ([b659a1d](https://github.com/solidSpoon/DashPlayer/commit/b659a1d9f22c2de2ff7bc19db7b715e55fe5cbd1))
