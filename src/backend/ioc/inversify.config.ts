...
import { SubtitleServiceImpl } from '@/backend/services/SubtitleServiceImpl';
...
import FavouriteClipsServiceImpl from '@/backend/services/FavouriteClipsServiceImpl';
...
import VideoLearningServiceImpl from '@/backend/services/VideoLearningServiceImpl';
import VideoLearningApiController from '@/backend/controllers/VideoLearningApiController';
import FfmpegService from '@/backend/services/FfmpegService';
import FfmpegServiceImpl from '@/backend/services/FfmpegServiceImpl';
...
import ChatServiceImpl from '@/backend/services/ChatServiceImpl';
import ChatSessionServiceImpl from '@/backend/services/ChatSessionServiceImpl';
import AiProviderServiceImpl from '@/backend/services/AiProviderServiceImpl';
import ModelRoutingServiceImpl from '@/backend/services/ModelRoutingServiceImpl';
...
import TranslateServiceImpl from '@/backend/services/TranslateServiceImpl';
...
import WatchHistoryServiceImpl from '@/backend/services/WatchHistoryServiceImpl';
...
import { OpenAIServiceImpl } from '@/backend/services/OpenAIServiceImpl';
...
import { LocalTranscriptionServiceImpl } from '@/backend/services/LocalTranscriptionServiceImpl';
...
import WordMatchServiceImpl from '@/backend/services/WordMatchServiceImpl';
...
import VocabularyServiceImpl from '@/backend/services/VocabularyServiceImpl';
...
container.bind<SrtTimeAdjustService>(TYPES.SrtTimeAdjustService).to(SrtTimeAdjustService).inSingletonScope();
container.bind<SubtitleService>(TYPES.SubtitleService).to(SubtitleServiceImpl).inSingletonScope();
container.bind<SystemConfigService>(TYPES.SystemConfigService).to(SystemConfigService).inSingletonScope();
