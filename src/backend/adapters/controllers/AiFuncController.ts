...
export default class AiFuncController implements Controller {
    ...
    registerRoutes(): void {
        ...
        registerRoute('ai-func/polish', (p) => this.aiFuncService.polish(p));
        ...
        registerRoute('ai-func/chat', (p) => this.aiFuncService.chat(p));
        ...
        registerRoute('ai-func/explain-select-with-context', (p) => this.aiFuncService.explainSelectWithContext(p));
        registerRoute('ai-func/explain-select', (p) => this.aiFuncService.explainSelect(p));
