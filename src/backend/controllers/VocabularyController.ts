...
interface GetAllWordsResult {
    success: boolean;
    data?: any[];
    error?: string;
}

interface ExportTemplateResult {
    success: boolean;
    data?: string;
    error?: string;
}
...
export class VocabularyController {
    private static instance: VocabularyController;

    static getInstance(): VocabularyController {
        if (!VocabularyController.instance) {
            VocabularyController.instance = new VocabularyController();
        }
        return VocabularyController.instance;
    }
