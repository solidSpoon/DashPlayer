...
const PlayerP = () => {
    ...
    const h = cpW.bind(null, useLayout((s) => s.height));
    ...
    return (
        <div
            ...
            style={{
                gridTemplateColumns: w('lg') ? '15% 60% 25%'
                    : (h('md') ? '65px calc((100% - 65px) * 12 / 17) calc((100% - 65px) * 5 / 17)'
                        : '65px calc((100% - 65px) * 1 / 2) calc((100% - 65px) * 1 / 2)'), // 这里定义每列的大小
            ...
            <AnimatePresence>
                {showSideBar && (
                    <>
                        ...
                        <motion.div
                            className={cn(
                                'hidden row-start-1 col-start-2 row-end-3 col-end-2 p-4',
                                w('md') && 'block col-end-2 pr-2',
                                h('md') && 'block row-end-2 pb-2',
                                !w('md') && h('md') && 'hidden',
                            )}
                            initial={{ y: -1000 }}
                            animate={{
            ...
            {(
                <div
                    ...
                    style={{
                        ...
                        gridArea: '1 / 1 / -1 / -1',
                        transform: showSideBar ? `translate(${pos.x}px, ${pos.y}px) scale(${pos.scale})` : 'translate(0px, 0px) scale(1)',
