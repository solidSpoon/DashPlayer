...
import { cn, strBlank } from '../../../utils/Util';
...
const FilterEditor = ({ keyName }: FilterEditorProps) => {
    ...
    const className =
        ' text-lg grid place-content-center h-[25px]';
    ...
    return (
        <div
            className={cn(
                'grid grid-cols-4 grid-rows-1 w-full items-center gap-2 whitespace-nowrap py-1'
            )}
            style={{
