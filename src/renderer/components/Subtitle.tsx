...
export default function Subtitle({
    ...
    const render = () => {
        return (
            ...
            <Virtuoso
                ref={listRef}
                className="h-full w-full overflow-y-scroll scrollbar-thin  scrollbar-track-stone-200 scrollbar-thumb-teal-900 hover:scrollbar-thumb-teal-800 scrollbar-thumb-rounded"
                data={subtitles}
