    ...
    render() {
        return (
            <>
                ...
                <a
                    className="flex place-content-center bg-lime-700 hover:bg-lime-600 rounded-full w-12 h-12 p-0.5 drop-shadow-md fixed bottom-12 right-12 z-50"
                    onClick={() => {
                        this.fileInputEl.current?.click(); // 当点击a标签的时候触发事件
                    }}
                >
                    <svg
                        className="icon m-auto fill-white w-1/2 h-1/2"
