...
import FileBrowser from '@/fronted/pages/player/components/file-browser/FileBrowser';
import {ControlBox} from '@/fronted/pages/player/components/control-box';
import ControlButton from '@/fronted/pages/player/components/ControlButton';
