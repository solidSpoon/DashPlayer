        ...
        <form className="w-full h-full flex flex-col gap-4">
            ...
            <ItemWrapper>
                <div className={"flex justify-start items-end gap-2"}>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                            ...
                            <DropdownMenuItem
                                onClick={() => {
                                    setSettingFunc("asr.provider")("xfyun");
                                }}
                            >
                                讯飞云语音
                            </DropdownMenuItem>
                ...
                <div className="flex flex-col gap-5 pl-2">
                    <Label>讯飞云语音配置</Label>
                    <SettingInput
                        setValue={setSettingFunc("apiKeys.xfyun.appId")}
                        title="应用AppID"
                        placeHolder="应用AppID"
                        inputWidth="w-64"
                        value={setting("apiKeys.xfyun.appId")}
                    />
                    <SettingInput
                        setValue={setSettingFunc("apiKeys.xfyun.secretKey")}
                        title="应用SecretKey"
                        placeHolder="******************"
                        inputWidth="w-64"
                        type="password"
                        value={setting("apiKeys.xfyun.secretKey")}
                    />
                </div>
            </ItemWrapper>
            <FooterWrapper>
